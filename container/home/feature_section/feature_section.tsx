...
const Features = () => {
  ...
  const myFeatures = [
    ...
    },
    {
      ...
      desc: "Our service is completely encrypted and we don’t share or sell any data to third parties.",
    ...
    },
    {
      ...
      desc: "We have a large number of experienced experts with many subjects and exam styles.",
  ...
  return (
    <>
      <FeaturesSection 
        mainHeading={<>Top-Notch Take My Class Solutions You Can <span>Count On</span></>}
        subText={
          <p>
            Are you feeling overwhelmed by tight deadlines and complex subjects? 
            You’re in the right place! From privacy to top grades, our hire someone 
            to take my online class service provides personalized guidance.
          </p>
        }
        features={myFeatures}
      />
