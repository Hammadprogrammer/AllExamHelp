...
export default function TestimonialSection() {
  ...
  const faqsData = [
    ...
    { q: "How do you check assignments for plagiarism? ", a: "Ans. All the assignments are written from scratch by our expert authors as per your needs. We try to make sure there is no plagiarism in every submission. We have a strict plagiarism detection system that ensures 100% unique and correctly referenced content, in order to gain the highest possible score at Turnitin." },
