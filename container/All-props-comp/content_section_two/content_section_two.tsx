          ...
          <div className={styles.textContent}>
            ...
            >
              <div className={styles.textBlock}>
                <h2 className={styles.heading}>{finalTitle1}</h2>
                <p className={styles.description}>{finalDesc1}</p>
              </div>
            </motion.div>
